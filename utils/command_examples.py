...
EXAMPLES_FR: Dict[str, List[str]] = {
    ...
    "rankcasinoembed": ["rankcasinoembed"],
    ...
    "addcoins": ["addcoins @membre 1000"],
    "removecoins": ["removecoins @membre 500"],
    "embedtrade": ["embedtrade"],
    "embedauction": ["embedauction"],
    "embedslots": ["embedslots"],
    "embedflip": ["embedflip"],
    "embedpfc": ["embedpfc"],
    ...
    "casinoranks sync": ["casinoranks sync", "casinoranks sync @membre"],
    "casinoranks setreq": ["casinoranks setreq 3 5000 50"],
    "casinoset lastgames": ["casinoset lastgames #historique"],
